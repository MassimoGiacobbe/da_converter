...
module da_converter_mm_interconnect_0 (
	...
	wire  [90:0] hex0_s1_agent_rf_source_data;                                                       // HEX0_s1_agent:rf_source_data -> HEX0_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] hex0_s1_agent_rsp_fifo_out_data;                                                    // HEX0_s1_agent_rsp_fifo:out_data -> HEX0_s1_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> HEX0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // HEX0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> HEX0_s1_agent:cp_channel
	...
	wire  [89:0] hex0_s1_agent_rp_data;                                                              // HEX0_s1_agent:rp_data -> router_005:sink_data
	...
	da_converter_mm_interconnect_0_router_003 router_004 (
	...
	da_converter_mm_interconnect_0_router_002 router_006 (
	...
	da_converter_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	da_converter_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	da_converter_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	da_converter_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	da_converter_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
